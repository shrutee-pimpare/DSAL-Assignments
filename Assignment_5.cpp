...
public:
    ...
    void hash_collision_linear_probing(long long mobile[], string name[], long long key)
    {
    ...
    void hash_collision_quadratic_probing(long long mobile[], string name[], long long key)
    {
        int adr = hash_function(key);
        int i = 1;
        while (mobile[(adr % 10)] != 0)
    ...
    int hash_function(long long key)
    {
        return key % 10;
    }
};
